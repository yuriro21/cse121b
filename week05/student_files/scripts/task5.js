...
document.querySelector("#message1").innerText = message1;
...
const getTemples = async () => {
    ...
    const response = await fetch("byui-cse.github.io/cse121b-course/week05/temples.json");
